...
class Coffee extends StatefulWidget {
  ...
  final String title;
  final String price;
   Coffee({Key? key, required this.image, required this.title, required this.price}) : super(key: key);
                        ...
                        children: [
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: Text(listOfStarValue[index], style: TextStyle(
                                              fontFamily: "Rosarivo",
                                              fontWeight: FontWeight.w400,
                                              fontSize: 13,
                                              color: Colors.white),))
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  child: Text(listOfPrice[index], style: TextStyle(
